							...
							<tbody>
		  						<c:forEach items="${animalInfoList}" var="animalInfo">
		    						<tr>
										...
										<td>
											<button class="smBtn" type="button" onclick="return updateConfirm(${animalInfo.animalNum})">수정</button>
											<button class="smBtn" type="button" onclick="return deleteConfirm(${animalInfo.animalNum})">삭제</button>
										</td>
		    						</tr>
		    					</c:forEach>
	  						</tbody>
