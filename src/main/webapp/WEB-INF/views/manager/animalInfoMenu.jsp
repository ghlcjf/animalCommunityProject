...
<c:choose>
	<c:when test="${empty animalInfoList}">
			<p>게시글이 없습니다.</p>
			<button class="btn btn-primary" type="button" onclick="return insertConfirm()">글작성</button>
	</c:when>
		...
		<table class="table">
		  ...
		  <tbody>
		    ...
		    <tr>
				...
				<td>
					<button class="btn btn-primary btn-sm" type="button" onclick="return updateConfirm(${animalInfo.animalNum})">수정</button>
					<button class="btn btn-primary btn-sm" type="button" onclick="return deleteConfirm(${animalInfo.animalNum})">삭제</button>
				</td>
		    </tr>
		    </c:forEach>
		  </tbody>
