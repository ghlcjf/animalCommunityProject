		...
		<table class="table">
			...
			<c:forEach items="${issueBoardList}" var="issueBoard">
				...
				<tr>
					...
					<td>
						<button class="btn btn-primary btn-sm" type="button" onclick="return updateConfirm(${issueBoard.issueNum})">수정</button>
						<button class="btn btn-primary btn-sm" type="button" onclick="return deleteConfirm(${issueBoard.issueNum})">삭제</button>
