				 			...
				 			<tbody>
							 	<c:forEach items="${imageList}" var="image">
							  		<tr>
										...
										<td>
											<button class="smBtn" type="button" onclick="return updateConfirm(${image.imageNum})">수정</button>
											<button class="smBtn" type="button" onclick="return deleteConfirm(${image.imageNum})">삭제</button>
										</td>
								  	</tr>
							    </c:forEach>
				  			</tbody>
